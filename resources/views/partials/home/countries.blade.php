...
<section class="py-5 bg-light overflow-hidden" id="destinations">
    <div class="container py-5">
        <div class="row align-items-center mb-5">
            <div class="col-md-8">
                <h6 class="text-primary fw-bold text-uppercase small mb-3" style="letter-spacing:1px;">Where We Can Take You</h6>
                <h2 class="display-5 fw-bold mb-3">Popular Destinations.</h2>
                <p class="text-secondary">We process visas and arrange travel to over 50 countries worldwide.</p>
            </div>
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="#cta" class="btn-kasb-custom">
                    <span>View All Destinations</span>
                    <div class="icon-circle-kasb"><i class="bi bi-chevron-right"></i></div>
                </a>
            </div>
        </div>

        <div class="swiper destinations-slider pb-5">
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Business · Residence</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Business · Medical</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Student · Business</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Business · Student</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Business · Trade</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift">
                        ...
                        <div class="card-body p-3">
                            ...
                            <p class="text-secondary small mb-2">Tourist · Medical · Business</p>
                            <a href="#cta" class="text-primary fw-bold text-decoration-none small">Apply for Visa <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-pagination dest-pagination"></div>
        </div>
    </div>
</section>

<style>
    .dest-pagination .swiper-pagination-bullet { width: 10px; height: 10px; background: #004a99; opacity: 0.3; }
    .dest-pagination .swiper-pagination-bullet-active { width: 25px; border-radius: 20px; background: #004a99; opacity: 1; }
</style>
