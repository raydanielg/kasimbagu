        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="https://wa.me/255700000000" class="kasb-social" style="background:#25d366;"><i class="bi bi-whatsapp"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-6">
                ...
                <ul class="list-unstyled kasb-footer-links">
                    ...
                    <li><a href="#services"><i class="bi bi-chevron-right me-2 text-warning"></i>Services</a></li>
                    <li><a href="#destinations"><i class="bi bi-chevron-right me-2 text-warning"></i>Destinations</a></li>
                    <li><a href="#why"><i class="bi bi-chevron-right me-2 text-warning"></i>Why Us</a></li>
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-warning"></i>Contact</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-6">
                ...
                <ul class="list-unstyled kasb-footer-links">
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-success"></i>Flight Booking</a></li>
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-success"></i>Visa Assistance</a></li>
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-success"></i>Hotel Booking</a></li>
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-success"></i>Consultancy</a></li>
                    <li><a href="#cta"><i class="bi bi-chevron-right me-2 text-success"></i>ICT Solutions</a></li>
                </ul>
            </div>
        ...
        <div class="row mt-5 pt-4" style="border-top:1px solid rgba(255,255,255,0.06);">
            <div class="col-lg-4">
                ...
                <div class="kasb-footer-contact">
                    ...
                    <p class="mb-0"><i class="bi bi-telephone-fill text-warning me-2"></i><a href="tel:+255700000000" class="text-secondary text-decoration-none">+255 700 000 000</a></p>
                </div>
            </div>
            ...
            <div class="col-lg-8 mt-4 mt-lg-0">
                ...
                <form class="row g-2">
                    <div class="col-sm-8 col-md-9">
                        <input type="email" class="form-control border-0 py-2 shadow-none" placeholder="Enter your email address" style="background-color:rgba(255,255,255,0.05);color:white;">
                    </div>
