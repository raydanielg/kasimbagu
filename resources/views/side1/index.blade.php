    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            @foreach([
                ...
                ['icon'=>'bi-people-fill','color'=>'#8b5cf6','title'=>'Partnership','desc'=>'Many partnerships operate informally and risk legal exposure. We can support you in formalizing structure, registering with BRELA, and setting up tax compliance—so you can focus on growing together.']
            ] as $i => $client)
...
<section id="blog" class="py-5 position-relative overflow-hidden k1-animate-on-scroll" style="background:linear-gradient(155deg,#f8f9fa 0%,#ffffff 100%);">
    ...
    <div class="container py-4 position-relative" style="z-index:1;">
        <div class="row align-items-end mb-5">
            <div class="col-lg-7 col-md-12 k1-animate-left k1-stagger-1">
                <span class="k1-section-badge" style="background:rgba(201,153,58,0.1);border-color:rgba(201,153,58,0.3);color:var(--gold);"><i class="bi bi-briefcase me-2"></i>Consultancy</span>
                <h2 class="display-4 fw-bold mt-2" style="font-family:'EB Garamond',serif;">Our <span style="color:var(--gold);">Services</span></h2>
                <p class="text-secondary mt-3" style="font-size:1.05rem;line-height:1.7;">Comprehensive legal, business, and research consultancy services for individuals and organizations.</p>
            </div>
            <div class="col-lg-5 col-md-12 text-lg-end text-center mt-3 mt-lg-0 k1-animate-right k1-stagger-2">
                <a href="#contact" class="btn btn-lg rounded-0 px-5 fw-bold text-dark" style="background:var(--gold);box-shadow:0 4px 20px rgba(201,153,58,0.3);">Get Started <i class="bi bi-arrow-right ms-2"></i></a>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-1">
                <div class="k1-svc-card">
                    <div class="k1-svc-icon" style="background:rgba(201,153,58,0.15);color:var(--gold);">
                        <i class="bi bi-journal-richtext"></i>
                    </div>
                    <h5 class="fw-bold mb-2">Legal Activities</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">Litigation, mediation, arbitration, immigration, family law, and criminal defence services.</p>
                    <a href="#legal" class="text-decoration-none fw-bold small" style="color:var(--gold);">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-2">
                <div class="k1-svc-card">
                    ...
                    <h5 class="fw-bold mb-2">Research & Consultancy</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">Research writing, proposals, concept notes, business plans, and synopsis development.</p>
                    <a href="#research" class="text-decoration-none fw-bold small" style="color:#0d9488;">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-3">
                <div class="k1-svc-card">
                    <div class="k1-svc-icon" style="background:rgba(29,78,216,0.15);color:#60a5fa;">
                        <i class="bi bi-building-fill"></i>
                    </div>
                    <h5 class="fw-bold mb-2">Company & Org. Management</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">BRELA registration, organizational structuring, construction company setup, and SACCOS registration.</p>
                    <a href="#company" class="text-decoration-none fw-bold small" style="color:#60a5fa;">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-4">
                <div class="k1-svc-card">
                    <div class="k1-svc-icon" style="background:rgba(16,185,129,0.15);color:#10b981;">
                        <i class="bi bi-people-fill"></i>
                    </div>
                    <h5 class="fw-bold mb-2">NGO & CSO Services</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">NGO, CBO, CSO, Charity, Foundation, Society, and Trust registration services.</p>
                    <a href="#ngo" class="text-decoration-none fw-bold small" style="color:#10b981;">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-5">
                <div class="k1-svc-card">
                    <div class="k1-svc-icon" style="background:rgba(251,146,60,0.15);color:#fb923c;">
                        <i class="bi bi-receipt"></i>
                    </div>
                    <h5 class="fw-bold mb-2">TRA Compliance</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">TIN registration, VAT, SDL, PAYE, tax assessment, and penalty resolution services.</p>
                    <a href="#company" class="text-decoration-none fw-bold small" style="color:#fb923c;">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 k1-animate-scale k1-stagger-6">
                <div class="k1-svc-card">
                    <div class="k1-svc-icon" style="background:rgba(139,92,246,0.15);color:#8b5cf6;">
                        <i class="bi bi-airplane-engined"></i>
                    </div>
                    <h5 class="fw-bold mb-2">Travel Services</h5>
                    <p class="text-secondary mb-3" style="font-size:0.9rem;line-height:1.7;">Airline ticketing, tour packages, pilgrimage packages, and visa services.</p>
                    <a href="#travel" class="text-decoration-none fw-bold small" style="color:#8b5cf6;">Learn More <i class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
    </div>
