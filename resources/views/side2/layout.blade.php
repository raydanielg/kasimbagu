...
<head>
    ...
    <title>Kasimbagu Safaris and Tour Agency</title>
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('travel') }}">
            ...
            <div style="line-height:1.1;">
                ...
                <div style="font-size:0.58rem;letter-spacing:2.5px;color:#7dd3fc;font-weight:700;text-transform:uppercase;">Safaris and Tour Agency</div>
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="k2Collapse">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="{{ route('consultacy') }}" class="btn btn-sm btn-outline-light rounded-0 px-3 fw-semibold">
                    <i class="bi bi-briefcase me-1"></i>Consultancy
                </a>
                <a href="#contact" class="btn btn-sm rounded-0 px-4 fw-bold text-dark" style="background:#38bdf8;">Book Now</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="k2Offcanvas" style="background:#020c1d;max-width:280px;">
    <div class="offcanvas-header py-4" style="border-bottom:1px solid rgba(255,255,255,0.07);">
        <div class="d-flex align-items-center gap-2">
            ...
            <div style="line-height:1.1;">
                ...
                <div style="font-size:0.56rem;letter-spacing:2px;color:#7dd3fc;font-weight:700;">SAFARIS AND TOUR</div>
            </div>
        </div>
    ...
    <div class="offcanvas-body p-4">
        ...
        <div class="mt-4 d-grid gap-2">
            <a href="{{ route('consultacy') }}" class="btn btn-outline-light rounded-0"><i class="bi bi-briefcase me-1"></i>Consultancy</a>
            <a href="#contact" class="btn rounded-0 fw-bold text-dark" style="background:#38bdf8;" data-bs-dismiss="offcanvas">Book Now</a>
        </div>
    </div>
</div>
    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <div style="line-height:1.1;">
                        ...
                        <div style="font-size:0.58rem;letter-spacing:2px;color:#7dd3fc;font-weight:700;">SAFARIS AND TOUR AGENCY</div>
                    </div>
                </div>
                <p style="color:#64748b;font-size:0.88rem;line-height:1.8;">Your trusted partner for flights, visas, hotels, tours, and seamless safaris and tour experiences across 50+ global destinations.</p>
        ...
        <div class="row mt-5 pt-3" style="border-top:1px solid rgba(255,255,255,0.05);">
            <div class="col-12 text-center" style="color:#334155;font-size:0.83rem;">
                &copy; {{ date('Y') }} Kasimbagu Safaris and Tour Agency. All rights reserved. &nbsp;|&nbsp;
